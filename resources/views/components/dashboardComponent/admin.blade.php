    ...
    <div class="min-h-screen flex">
        ...
        <aside class="bg-primary-600 text-white w-64 px-4 py-6 fixed h-full shadow-xl">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('tableGenre')}} " class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors hover:bg-primary-500 {{ request()->is('tableGenre') ? 'bg-primary-700' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
