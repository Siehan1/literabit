<x-layout.admin>
    <x-slot name="header">Upload Buku</x-slot>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="pdf_file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-xl cursor-pointer hover:bg-gray-50 transition-all duration-200">
