<x-dashboardComponent.admin>
    ...
    <a href="{{ route('missionTemplate.index') }}" class="hidden md:block"><i class="bi bi-arrow-left text-4xl hover:text-primary transition-colors duration-200"></i></a>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
            <h2 class="text-2xl font-bold text-primary mb-8 text-center">Edit Template Baru</h2>


            <form action="{{ route('missionTemplate.update', $template->id) }}" method="POST" class="space-y-6">
                @csrf 
                {{-- Input Fields --}}
