<x-dashboardComponent.admin>
    ...
    <div class="w-full text-end mb-6">
        <a href="{{route('Badges')}}" class="bg-secondary-600 px-4 py-3 rounded-2xl hover:bg-secondary-800 text-white transition-colors duration-20">Tambah Badge</a>
    </div>
    ...
    <x-dashboardComponent.table>
        ...
        <x-slot name="thead">
            ...
            <th class="px-6 py-3 text-left text-[14px] font-semibold uppercase w-1/6">Gambar</th>
