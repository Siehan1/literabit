<x-dashboardComponent.admin>
    ...
    <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <form action="{{route('Badges')}}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <!-- name badges -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="nama_badge" class="block text-sm font-medium text-teks ">Nama Badges <span class="text-red-500">*</span></label>
                        <input type="text" id="nama_badge" required name="nama_badge" placeholder="Masukan nama badges" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-primary focus:ring focus:ring-primary/20 focus:outline-none transition-all duration-200">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="description" required name="description" placeholder="Masukan Deskripsi" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-primary focus:ring focus:ring-primary/20 focus:outline-none transition-all duration-200">
                    </div>

                    <!-- icon badges -->
                    <div class="space-y-2 md:col-span-2">
                        <label for="icon_path" class="block text-sm font-medium text-teks">Masukan Gambar Badges <span class="text-red-500">*</span></label>
                        <div class="flex items-center justify-center w-full">
                            <label for="icon_path" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-xl cursor-pointer hover:bg-gray-50 transition-all duration-200">
                                ...
                                <input type="file" id="icon_path" required name="icon_path" class="hidden" />
                            </label>
                        </div>
                    </div>
