            ...
            <div class="flex flex-col sm:flex-row items-center gap-6">
                <div class="relative group mb-4 sm:mb-0">
                    <div class="w-24 h-24 bg-[#FFD8B8] rounded-2xl flex items-center justify-center overflow-hidden">
                        <img id="avatar-preview" src="{{ asset(Auth::user()->profil ? 'storage/' . Auth::user()->profil : 'profile_penulis/pro1.svg')}}" 
                    ...
                    <form action="{{ route('profile.avatar') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <label for="avatar-input" class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity cursor-pointer">
